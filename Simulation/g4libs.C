...
void g4libs()
{
  ...
  gSystem->AddIncludePath("-I/gpfs/mnt/gpfs02/phenix/hhj/hhj1/shlim/work/02.datafiles/01.simfiles/mysetup/geant4_vmc/include/geant4vmc");
  ...
  cout << "Loading fvtx library..." << endl;
