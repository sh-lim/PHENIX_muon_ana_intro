...
void RunMyMacro(const char *modulemacro = "Run_picodstobject_tutorial.C",
                const char *outfile = "out.root",
                const int nevnt = 10000,
                const char *system  = "Run15pp200CAMUP108")


// Linear: for valgrind and insure
// RunMyMacro(const char *modulemacro = "Run_Run11AuAu_EMC_Sigmalization.C", const char *outfile = "test-Run11AuAu_EMC_Sigmalization.root", const int nevnt = 1000,const char *system  = "Run11AuAu200MinBiasPro101")

{
  ...
  if (strcmp(system, "Test") == 0)
  ...
  else if (strcmp(system, "Run12pp200MPC") == 0)
    {
      ...
      dst_evefile = "DST_EVE_MPC_run12pp_200GeV_pro91-0000360934-9000.root";
      dst_mpcfile = "DST_MPC_MPC_run12pp_200GeV_pro91-0000360934-9000.root";
      dst_svxfile = "DST_SVX_MPC_run12pp_200GeV_pro91-0000360934-9000.root";
